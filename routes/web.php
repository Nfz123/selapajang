...
use App\Http\Controllers\Siode\Pemerintahdesa\PemerintahanController;
...
Route::get('/petadesafront', [HomeController::class, 'petadesafront'])->name('home.petadesafront');
Route::get('/karangtarunafront', [HomeController::class, 'karangtarunafront'])->name('home.karangtarunafront');
Route::get('/lpmfront', [HomeController::class, 'lpmfront'])->name('home.lpmfront');
...
Route::group(['middleware' => ['auth'], 'prefix' => 'siode', 'as' => 'siode.'], function () {
    ...
    Route::group(['middleware' => ['auth'], 'prefix' => 'info-desa', 'as' => 'infodesa.'], function () {
        ...
        Route::patch('/update-desa/{desa}', [IdentitasDesaController::class, 'update'])->name('identitas-desa.update');
                        ...
                        //PEMERINTAH DESA
        Route::get('/pemerintahandesa', [PemerintahanController::class, 'index'])->name('pemerintah.index');
